package com.atguigu.gmall.util.interceptors;

import com.alibaba.fastjson.JSON;

import com.atguigu.gmall.util.annotations.LoginRequired;
import com.atguigu.gmall.util.util.CookieUtil;
import com.atguigu.gmall.util.util.HttpclientUtil;
import com.atguigu.gmall.util.util.JwtUtil;
...
public class AuthInterceptor extends HandlerInterceptorAdapter {
        ...
        public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
            ...
            // 获得用户的token
            String oldToken = CookieUtil.getCookieValue(request, "token", true);// 之前写入的老token
            String newToken = request.getParameter("token");// 未经一次验证的新token
            String token = "";
